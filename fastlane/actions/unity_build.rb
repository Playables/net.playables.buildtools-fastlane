    ...
    class UnityBuildAction < Action
      def self.run(params)
       ...
       projectsettings_text = File.open(projectsettings_path, &:readline)
        ...
        build_name = File.basename(build_path, ".*")
      ...
      def self.available_options
        ...
        [
          ...
          FastlaneCore::ConfigItem.new(key: :debug_path,
                                       env_name: "FL_UNITY_DEBUG_PATH", # The name of the environment variable
                                       description: "Debug infos (Burst, symbols) output path", # a short description of this parameter                                     
                                       is_string: true, 
                                       default_value:""),
